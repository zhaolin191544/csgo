<template>
    <TextType
        :text="[
            ...
            'Web-based BIM Intelligent Collaboration Platform',
        ]"
        :typingSpeed="40"
        :pauseDuration="1500"
        :deletingSpeed="20"
...
const hyperspeedContainer = useTemplateRef<HTMLDivElement>(
    "hyperspeedContainer",
);
...
.my-typewriter {
    font-family:
        "Courier New", Courier, monospace; /* 使用等宽字体更有打字机效果 */
